...
function renderNavbar($user = null, $pageTitle = 'Dashboard') {
    ...
    ?>
    <!-- Top Navigation -->
    <header x-data="{ userMenuOpen: false, notificationsOpen: false }"
            class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 lg:pl-64">
                    ...
                    <div class="relative">
                        <button @click="userMenuOpen = !userMenuOpen"
                            ...
                            <div class="w-8 h-8 bg-primary-600 rounded-full flex items-center justify-center">
                                <span class="text-white text-sm font-medium"><?= strtoupper(substr($user, 0, 1)) ?></span>
                            </div>
                            <span class="hidden sm:block text-sm font-medium text-gray-700 dark:text-gray-300"><?= htmlspecialchars($user) ?></span>
                        ...
                        <div x-show="userMenuOpen"
                             ...
                             style="display: none;">
                            <div class="py-1">
                                <a href="./disconnect" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                    <div class="flex items-center">
